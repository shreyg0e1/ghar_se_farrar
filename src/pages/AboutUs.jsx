                ...
                <div className="bg-white rounded-2xl overflow-hidden relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent p-6">
                    ...
                    <div className="flex gap-3">
                      <a
                        href="https://www.instagram.com/ashishverma___?igsh=YjIza3lndWphYnJt"
                        target="_blank"
                      ...
                      <a
                        href="https://youtube.com/@imashishverma?si=6H4gkkGPWNeXEt3B"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-5">
                  A travel influencer who’s explored India and beyond capturing
                  raw landscapes, stranger encounters, and solo journeys.
                  Through every trip, he weaves soulful stories that turn
            ...
            <div className="space-y-6 order-2 lg:order-1">
              <div>
                ...
                <p className="text-lg text-white/90 leading-relaxed mb-5">
                  Ex-Microsoft SWE, now full-time explorer. I’ve travelled every
                  Indian state to build Ghar se Faraar a venture blending tech
                  finesse with soulful journeys. Wander with purpose, beyond
                  maps and meetings.
                </p>
              ...
              <div className="relative transform group-hover:-rotate-2 transition-all duration-500 w-full">
                <div className="bg-white rounded-3xl overflow-hidden shadow-2xl relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent p-6">
                    ...
                    <div className="flex gap-3">
                      <a
                        href="https://www.instagram.com/anmol_agnihotri?igsh=MWl1Mmt5MTFtbWZueQ=="
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-gradient-to-br from-purple-500 to-pink-500 text-white p-3 rounded-xl hover:scale-110 hover:shadow-xl transition-all duration-300 cursor-pointer active:scale-95 group/icon"
                      >
                      ...
                      <a
                        href="https://www.linkedin.com/in/anmolagni"
                        target="_blank"
                        rel="noopener noreferrer"
