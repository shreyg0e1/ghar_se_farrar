...
const BuzzTestimonials = () => {
  ...
  // YouTube video initialization commented
  useEffect(() => {
          ...
          {videoRefs.map((ref, idx) => (
            <div key={idx} className="relative flex justify-center group">
              <div
                ...
                } rounded-2xl overflow-hidden shadow-2xl relative bg-gray-200 flex items-center justify-center`}
              >
                {/* Video Placeholder */}
                <div className="text-center text-gray-600">
                  <div className="text-2xl font-bold mb-2">Video {idx + 1}</div>
                  <div className="text-sm">Placeholder</div>
                </div>

                {/* Original Video Player - Commented */}
            ...
            {videoRefs.map((ref, idx) => (
              <div key={idx} className="relative group">
                <div
                  ...
                  } rounded-xl overflow-hidden shadow-2xl relative bg-gray-200 flex items-center justify-center`}
                >
                  {/* Video Placeholder */}
                  <div className="text-center text-gray-600">
                    <div className="text-sm font-bold">Video {idx + 1}</div>
                  </div>

                  {/* Original Video Player - Commented */}
                  {/* <div ref={ref} id={`player${idx}-tablet`} className="w-full h-full"></div> */}
            ...
            {videoRefs.map((ref, idx) => (
              <div key={idx} className="relative flex-shrink-0 group">
                <div
                  ...
                  } rounded-xl overflow-hidden shadow-xl relative bg-gray-200 flex items-center justify-center`}
                >
                  {/* Video Placeholder */}
                  ...
                  {/* Original Video Player - Commented */}
                  {/* <div ref={ref} id={`player${idx}-mobile`} className="w-full h-full"></div> */}
