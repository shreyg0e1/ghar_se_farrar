...
const GalleryMasonryGrid = ({
  images = [
    {
      id: 1,
      src: "/gallery/galleryimg1.jpeg",
      alt: "Mountain landscape",
      span: 2, // Takes 2 rows
    },
    {
      id: 2,
      src: "/gallery/galleryimg2.jpeg",
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(to bottom, rgba(255, 255, 255, 0.9), rgba(245, 237, 224, 0.4))",
          ...
          {images.map((image) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(139, 115, 85, 0.3) 0%, rgba(74, 44, 42, 0.5) 100%)",
